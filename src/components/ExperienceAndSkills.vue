        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 xl:px-16">
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-[80%]">
                <h2 class="text-4xl font-bold text-white text-left mb-4">My 
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Skills Level</span>
                </h2>
...
const Experinces =ref([
    {
        id:1,
        role:'Junior Aeronautical Engineer',
        company:'Agni Aerosport Adventures Academy, Bangalore, Karnataka',
        date:'3 Month Internship'
    },
    {
        id:2,
        role:'Freelancing Tutor',
        company:'Pear Deck Tutors, USA',
        date:'2020 - 2024'
    },
])
</script>