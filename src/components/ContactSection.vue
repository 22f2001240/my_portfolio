<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Interested in working together? I'm available for full-time roles, freelance projects, or internships—let’s connect!
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>Email</h4>
                            <p>nihilapallath159@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <a href="https://www.linkedin.com/in/nihila-pallath007">linkedin.com/in/nihila-pallath007</a>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                        ...
                        <div class="ml-5 text-white">
                            <h4>github</h4>
                            <a href="https://github.com/22f2001240">https://github.com/22f2001240</a>
                        </div>
                    </div>
                </div>
            </div>
